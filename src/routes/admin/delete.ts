...
export default class AdminDeleteTimezone extends Route {
  constructor() {
    super(RouteType.DELETE, '/admin/timezones/:userId');
  }
  ...
  async handle(req: Request, _res: Response) {
    ...
    const timezones = Timezones.delete(validParamData.userId, validBodyData.timezone);
